---
title: "Teach Yourself R Tutorial #1"
...
> [link](https://cran.r-project.org/web/packages/cowsay/cowsay.pdf)

> [link](https://cran.r-project.org/web/packages/fortunes/fortunes.pdf)
...
We can write another function that combines `cowsay` and `fortunes`.
